...
public class Relation {
	...
	public static void createRuleRelations() throws CustomException {
		...
		min = Network.defineRelation("min", "Individual", "none", 1);
		max = Network.defineRelation("max", "Individual", "none", 1);
		i = Network.defineRelation("i", "Individual", "none", 1);
		thresh = Network.defineRelation("thresh", "Individual", "none", 1);
		threshMax = Network.defineRelation("threshmax", "Individual", "none", 1);
	}
